...
public class Replicante {
    ...
    private static LinkedList<Replicante> listaReplicantes = new LinkedList<>();
    private String nombre;
    private int vitalidad;
    private int escudo;
    private int potencia;

    public Replicante(String nombre, int vitalidad, int potencia){
        this.nombre = nombre;
    ...
    public boolean atacar(Replicante enemigo){
    ...
    public static LinkedList<Replicante> getListaReplicantes(){
        return (LinkedList<Replicante>) listaReplicantes.clone();
    }
