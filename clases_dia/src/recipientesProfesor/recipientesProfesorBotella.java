...
public class recipientesProfesorBotella {

    // Atributos
    // TODO: TipoContenido es un enumerado con tres opciones [AGUA, TE, CAFE], debemos crearlo.
    private recipientesProfesorTipoContenido contenido;
    private final float CAPACIDAD_MAXIMA = 300;
    private Boolean abierta;
    private float cantidadMl;

    // Constructor
    public recipientesProfesorBotella(recipientesProfesorTipoContenido cont){
        this.abierta = false;
        this.contenido = cont;
    ...
    public recipientesProfesorBotella(){
